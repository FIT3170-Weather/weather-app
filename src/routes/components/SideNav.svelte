...
<div class="hidden fixed top-0 left-0 bottom-0 w-16 bg-base-200 md:block z-50">
	<div class="flex flex-col items-center h-full gap-5 pt-24">
		...
		<div class="w-full flex justify-center">
			<a
				href="/forecast"
				class="icon-container w-12 h-12 rounded-2xl flex justify-center items-center"
			>
		...
		<div class="pb-5 w-full flex justify-center">
			...
			>
				<img
					src={$user ? '/images/log-out.png' : '/images/log-in.png'}
				...
				{:else}
					...
					<div class="text-center">
						<button
							...
							on:click={() => authHandlers.loginWithGoogle(closeModal)}
						>
